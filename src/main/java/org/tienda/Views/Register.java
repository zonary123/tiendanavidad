...
public class Register extends javax.swing.JFrame {
  ...
  public void initTextFields() {
    mRegister.actualizarTextField(getJTextFieldUsername(), this.lenguaje.getMensaje().getString("login.username.placeholder"), 16, "img/svg/Person.svg", 22, 24, "#575DFB");
    mRegister.actualizarTextField(getJPasswordFieldPassword(), this.lenguaje.getMensaje().getString("login.password.placeholder"), 16, "img/svg/Candado.svg", 16, 19, "#575DFB");
  }
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jPanelLogin.add(jLabelRegistrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 30, -1, -1));
        ...
        jLabelApellidos.setText(bundle.getString("register.label.apellidos")); // NOI18N
