...
import org.tienda.Controller.cForgotPasswordMail;
 ...
 */
@Getter
public class ForgotPasswordMail extends javax.swing.JFrame {
  private String email = "";
  private cForgotPasswordMail cFPP;
  ...
  public ForgotPasswordMail() {
    initComponents();
    try {
      this.cFPP = new cForgotPasswordMail(this);
    } catch (IOException e) {
      System.err.println("Error al cargar el lenguaje");
    }
  }
  ...
  private void initComponents() {
    ...
    jButtonConfirmar.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(ForgotPasswordMail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
