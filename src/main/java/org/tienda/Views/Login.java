...
public class Login extends javax.swing.JFrame {
  ...
  public Login() {
    ...
    mLogin.actualizarTextField(getJTextFieldUsername(), this.lenguaje.getMensaje().getString("login.username.placeholder"), 8, "img/svg/Person.svg", 22, 24);
    mLogin.actualizarTextField(getJPasswordFieldPassword(), this.lenguaje.getMensaje().getString("login.password.placeholder"), 8, "img/svg/Candado.svg", 16, 19);
  }
  ...
  private void initComponents() {
    ...
    jPanelLogin.add(jLabelLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 45, 200, 50));
