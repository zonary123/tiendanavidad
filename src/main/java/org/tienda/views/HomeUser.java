...
public class HomeUser extends javax.swing.JFrame {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        ContainerTitle.setBackground(new java.awt.Color(87, 93, 251));
        ContainerTitle.setFont(new java.awt.Font("Inter", 0, 16)); // NOI18N
        ContainerTitle.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        TituloCategorias.setFont(new java.awt.Font("Inter", 2, 16)); // NOI18N
        TituloCategorias.setForeground(new java.awt.Color(255, 255, 255));
        TituloCategorias.setText("Categorias");
        ContainerTitle.add(TituloCategorias, new org.netbeans.lib.awtextra.AbsoluteConstraints(4, 3, 130, 24));

        sideBar.add(ContainerTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 280, 30));
